        ...
        <div className="bg-zinc-50">
            <div className="container py-8 text-center lg:py-0 lg:text-left lg:flex lg:justify-between ">
                <div className="lg:w-1/2 xl:py-14 lg:py-8">
                    ...
                    <h1 className="py-4 text-3xl font-extrabold leading-tight text-orion-orange xl:text-6xl lg:text-4xl">An aesthetic room is <br />given harmony</h1>
                    ...
                    <button className="hidden items-center px-8 py-3 text-white rounded-full shadow-lg bg-gray-950 hover:bg-gray-800 hover:ring-2 hover:ring-gray-950 ring-offset-2 ">Get Started <TbArrowUpRight className="w-5 h-5 ml-2" /></button>
                </div>
